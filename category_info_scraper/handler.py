...
def scrape(event, context):
  data = get_categories()
  file_name = f"categories-{data['category']}"
  save_file_to_s3('school_categories', file_name, data)
...
def get_categories():
    ...
    soup_category_page = BeautifulSoup(html.content, "html")
    # Initialize the return category list
    all_categories = []
